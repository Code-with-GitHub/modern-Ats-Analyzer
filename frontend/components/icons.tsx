...
export const LogoIcon = (props) => (
    <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
...
export const SparklesIcon = ({ className = "w-5 h-5", ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m11-13v4m-2-2h4m2 11h-4m2 2v-4M12 2v2m-2 2h4m-4 7v2m2-2h-4" />
    </svg>
);
...
export const TwitterIcon = ({ className = "w-6 h-6", ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616v.064c0 2.295 1.634 4.208 3.803 4.649-.6.164-1.25.2-1.92.084.6 1.9 2.3 3.2 4.4 3.3-1.8.9-4.1.4-5.8.1-1.3-.8-2.3-2.1-2.6-3.6.8.1 1.7.2 2.5.2 2.2 0 4.3-.7 6-1.9 2.1 1.9 4.8 2.9 7.7 2.9 4.2 0 7.8-3.4 7.8-7.7 0-.2-.1-.4-.1-.6.9-.6 1.6-1.4 2.2-2.3z" />
    </svg>
);
